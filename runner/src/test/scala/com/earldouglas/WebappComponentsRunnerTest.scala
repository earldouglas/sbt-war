...
class WebappComponentsRunnerTest extends FunSuite {
  ...
  lazy val configuration: WebappComponentsConfiguration =
    WebappComponentsConfiguration
      .load("../../runner/src/test/resources/webapp-components.properties")
  ...
  test("/foo.html") {
    ...
    val obtained: HttpClient.Response =
      HttpClient.request(
        method = "GET",
        url = "http://localhost:8081/foo.html",
        headers = Map.empty,
        body = None
      )
  ...
  test("/bar.html") {
    ...
    val obtained: HttpClient.Response =
      HttpClient.request(
        method = "GET",
        url = "http://localhost:8081/bar.html",
        headers = Map.empty,
        body = None
      )
  ...
  test("/baz/raz.css") {
    ...
    val obtained: HttpClient.Response =
      HttpClient.request(
        method = "GET",
        url = "http://localhost:8081/baz/raz.css",
        headers = Map.empty,
        body = None
      )
