...
To set environment properties for the forked container JVM, set
...
By default, that will use port 5005.  (Use the same port in the -Xrunjdwp address.)
Name this configuration anything you like, and run this configuration in debug mode.

You can also try this sbt Command to run Tomcat in debug mode (use "debugTomcat" to run):
