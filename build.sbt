...
ThisBuild / crossScalaVersions := Seq("2.12.18", "3.7.4")
...
lazy val warRunner_4_0 =
  project
    ...
    .settings(
      ...
      crossPaths := false, // exclude Scala suffix from artifact names
      autoScalaLibrary := false, // exclude scala-library from dependencies
      libraryDependencies += "com.heroku" % "webapp-runner" % "9.0.109.0"
    )
...
lazy val warRunner_6_0 =
  project
    ...
    .settings(
      ...
      crossPaths := false, // exclude Scala suffix from artifact names
      autoScalaLibrary := false, // exclude scala-library from dependencies
      libraryDependencies += "com.heroku" % "webapp-runner" % "10.1.46.0"
    )
