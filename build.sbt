...
libraryDependencies += "com.amazonaws" % "aws-java-sdk-elasticbeanstalk" % "1.11.1016"
libraryDependencies += "com.amazonaws" % "aws-java-sdk-s3" % "1.11.1016"
...
scmInfo := Some(ScmInfo( url("https://github.com/earldouglas/xsbt-web-plugin"), "scm:git@github.com:earldouglas/xsbt-web-plugin.git"))
